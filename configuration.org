...
#+BEGIN_SRC emacs-lisp
  ...
  (setq iensu-org-files-alist
    `((appointments     ,(concat iensu-org-dir "/appointments.org"))
      ...
      (notes-dev        ,(concat iensu-org-dir "/notes.dev.org"))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package org-pivotal
    :load-path (lambda () (iensu--config-file "packages"))
    :config
    (setq org-pivotal-api-token *pivotal-api-token*))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
    (use-package synosaurus
      ...
      (add-hook 'org-mode-hook (lambda () (synosaurus-mode 1)))
)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package web-mode
    :init
    (dolist (ext (list "\\.html$" "\\.hbs$" "\\.handlebars$" "\\.jsp$" "\\.eex$" "\\.vue$"))
