...
#+begin_src emacs-lisp
    (use-package web-mode
      :mode ("\\.html$" "\\.hbs$" "\\.handlebars$" "\\.jsp$" "\\.eex$" "\\.vue$" "\\.tsx$")
      :hook
      (web-mode . emmet-mode)
      :custom
...
#+begin_src emacs-lisp
  ...
  (use-package tide
    ...
    :bind (:map tide-mode-map
                ...
                ("M-,"     . tide-jump-back)
                ("C-c t"   . hydra-tide/body))
    :pretty-hydra
    ((:color teal :quit-key "q" :title "Typescript Tide")
     ("Commands"
      (("d" tide-documentation-at-point "documentation at point")
       ("e" tide-project-errors "list errors")
       ("f" tide-fix "fix issue at point")
