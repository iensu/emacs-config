...
(defun iensu-add-to-list (list items)
...
(use-package smartparens
  ...
  :hook ((prog-mode . smartparens-mode) ; non-strict by default, but keep strict in LISPs
...
(add-to-list 'iensu-org-capture-templates
