...
;; Sets up Jedi and EPC for autocompletion and navigation
;; Requires epc and jedi to be installed
;; and you need to use virtualenv

;; First time this is run on a new machine execute
;;   M-x jedi:install-server
;; and deps will be installed in a sandboxed env
...
(defvar jedi-config:with-virtualenv nil ; "/Users/jens/Virtualenvs/ml-py27/"
...
;; ;; Helping jedi find the root of project and the virtualenv
;; ;; See https://github.com/wernerandrew/jedi-starter/blob/master/jedi-starter.el
;; ;; for more info
;; (defvar jedi-config:with-virtualenv nil
;;   "Set to non-nil to point to a specific virtualenv.")
...
;; ;; Set path explicitly for OSX when not using virtualenv
;; (defvar jedi-config:use-system-python nil
;;   "Set to t if using system python")
...
;; (defun jedi-config:set-python-executable ()
;;   (set-exec-path-from-shell-PATH) ;; OSX
;;   (make-local-variable 'jedi-server-command)
;;   (set 'jedi-server-command
